...
class ScikitModel:
    ...
    def __init__(self, combination, sheet_name, features, label):
        self.pipeline = make_pipeline(combination, MethodType.Regression)
    ...
    def predict_then_fit(self, feature_values_dict):
        test_input = []
        actual_value = calculate_score(self.sheet_name, feature_values_dict)
        ...
        predicted_value = self.pipeline.predict(test_input)
    ...
    def calculate_score(self, metric_type):
